...
def loadAllData(dataset_str):
    ...
    # names = ['allx', 'ally', 'edges', 'edges.weight', 'motifs.all', 'motifs.num']
    names = ['allx.shuffle', 'ally.shuffle', 'edges.shuffle', 'edges.weight.shuffle', 'motifs.all.shuffle', 'motifs.num.shuffle']
    objects = []
    for i in range(len(names)):
        with open(WORK_PATH + "ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
...
if __name__ == "__main__":
    ...
    changelabelnetwork(path, "acmv9", train_num=120, test_num=500)